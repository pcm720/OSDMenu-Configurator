...
static int lua_clear(lua_State *L) {
  ...
  if (argc == 1)
    ...
    color = GS_SETREG_RGBAQ(0x00, 0x00, 0x00, 0x80, 0x00);
  clearScreen(color);
  return 0;
}
...
static const luaL_Reg Screen_functions[] = {{"clear", lua_clear},
                                            {"flip", lua_flip},
...
static const luaL_Reg Color_functions[] = {{"new", lua_color}, {"getR", lua_getR}, {"getG", lua_getG},
                                           {"getB", lua_getB}, {"getA", lua_getA}, {0, 0}};

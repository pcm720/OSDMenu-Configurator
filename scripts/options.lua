...
config_options.osdmenu_cnf_categories = {
  ...
  },
  {
    options = {
      ...
      { key = "OSDSYS_left_cursor",           optType = "text",  default = "",                   maxLen = 10 },
      { key = "OSDSYS_right_cursor",          optType = "text",  default = "",                   maxLen = 10 },
      { key = "OSDSYS_menu_top_delimiter",    optType = "text",  default = "",                   maxLen = 80 },
      { key = "OSDSYS_menu_bottom_delimiter", optType = "text",  default = "",                   maxLen = 80 },
